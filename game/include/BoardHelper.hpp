...
public:
   ...
   * valid move.
   * @param board 2D char vector representing the current state of the board.
   * It will be updated with the new board state after reversing pieces.
  ...
  getAllPossibleMoves(const std::vector<std::vector<char>> &board, char player);
  ...
  /**
   * @brief Switches the player if the current player has no valid moves.
   * If no one can play, returns false.
   * @param board 2D char vector representing the board.
   * @param player The current player.
   ...
   */
  static int countPlayerPieces(const std::vector<std::vector<char>> &board, char player);
  ...
  getBoardAfterMove(const std::vector<std::vector<char>> &board, const Position &move, char player);
...
private:
  ...
  static std::vector<Position>
  checkUp(std::vector<std::vector<char>> &board, char player, const Position &pos);

  /** @brief Helper function to check in the up-right direction. */
  static std::vector<Position>
  checkUpRight(std::vector<std::vector<char>> &board, char player,const Position &pos);

  /** @brief Helper function to check in the right direction. */
  static std::vector<Position> 
  checkRight(std::vector<std::vector<char>> &board, char player, const Position &pos);
  ...
  static std::vector<Position>
  checkDownLeft(std::vector<std::vector<char>> &board, char player, const Position &pos);

  /** @brief Helper function to check in the left direction. */
  static std::vector<Position>
  checkLeft(std::vector<std::vector<char>> &board, char player, const Position &pos);

  /** @brief Helper function to check in the up-left direction. */
  static std::vector<Position>
  checkUpLeft(std::vector<std::vector<char>> &board, char player, const Position &pos);
};
